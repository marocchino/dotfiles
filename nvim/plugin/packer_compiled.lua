...
_G.packer_plugins = {
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/Users/marocchino/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  neotest = {
    config = { "\27LJ\2\n8\0\0\4\0\3\0\0056\0\0\0006\2\1\0'\3\2\0B\0\3\1K\0\1\0\19neotest-config\frequire\npcall\0" },
    loaded = true,
    path = "/Users/marocchino/.local/share/nvim/site/pack/packer/start/neotest",
    url = "https://github.com/nvim-neotest/neotest"
  },
  ["neotest-jest"] = {
    loaded = true,
    path = "/Users/marocchino/.local/share/nvim/site/pack/packer/start/neotest-jest",
    url = "https://github.com/haydenmeade/neotest-jest"
  },
  ["neotest-rspec"] = {
    loaded = true,
    path = "/Users/marocchino/.local/share/nvim/site/pack/packer/start/neotest-rspec",
    url = "https://github.com/olimorris/neotest-rspec"
  },
  ["neotest-vim-test"] = {
    loaded = true,
    path = "/Users/marocchino/.local/share/nvim/site/pack/packer/start/neotest-vim-test",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/marocchino/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["vim-bundler"] = {
    loaded = true,
    path = "/Users/marocchino/.local/share/nvim/site/pack/packer/start/vim-bundler",
