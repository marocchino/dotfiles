...
export PATH="$HOME/Library/Python/3.6/bin/:/usr/local/sbin:$HOME/bin:$GOPATH/bin:$HOME/Documents/flutter_macos_v1.9.1+hotfix.2-stable/bin/cache/dart-sdk/bin:$HOME/Documents/flutter_macos_v1.9.1+hotfix.2-stable/bin:$HOME/dotfiles/bash/functions:/usr/local/bin:$PATH"
export CLICOLOR=1
