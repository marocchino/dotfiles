...
export PATH="/Applications/Visual Studio Code.app/Contents/Resources/app/bin:$HOMEBREW_PREFIX/sbin:/Library/Apple/usr/bin:$HOME/bin:$GOPATH/bin:$HOME/dotfiles/bash/functions:$HOMEBREW_PREFIX/bin:$PATH"
